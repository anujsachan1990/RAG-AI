...
export function BrandIcon({ size = "md", showSparkle = true }: BrandIconProps) {
  const sizeClasses = {
    sm: "h-8 w-8",
    md: "h-10 w-10",
    lg: "h-32 w-32",
  ...
  return (
    <div className="relative inline-block">
      <img
        ...
        alt={frameworkConfig.branding.name}
        ...
        >
          ...
          >
            <path
              ...
              fill={frameworkConfig.theme.colors.primary}
              opacity="0.95"
            />
            <circle cx="12" cy="10" r="3" fill={frameworkConfig.theme.colors.accent} opacity="0.8" />
          </svg>
        </div>
      )}
    </div>
